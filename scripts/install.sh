...
REPO_DEFAULT="MoziaVerse/openviking-opencode-plugins"
REF_DEFAULT="main"
...
PLUGIN_URL="${OPENVIKING_OPENCODE_PLUGIN_URL:-https://raw.githubusercontent.com/${REPO}/${REF}/${PLUGIN_NAME}}"
...
Usage:
  bash <(curl -fsSL https://raw.githubusercontent.com/${REPO_DEFAULT}/main/scripts/install.sh)
